...
async function renderChart() {
    ...
    const canvasElement = document.getElementById('filmCountChart');

    if (!canvasElement) {
        console.error("Canvas element 'filmCountChart' not found.");
        if (errorMessageDiv) {
...
// Since ChartRenderingScript.js is loaded with 'defer',
